...
\section{中微子天文学热门课题}
\subsection{高能中微子起源}
自 IceCube 探测到来自宇宙深处的弥散高能中微子流以来，确定这些中微子的具体天体物理起源一直是该领域的首要目标。研究
正从对弥散信号的分析转向对单个或某几类特定源的识别。

\subsection{AGN 作为候选}
活动星系核被认为是高能中微子的最有希望的来源之一。当前的研究热点是深入探讨AGN内部不同的物理模型和区域，以确定
中微子产生的具体机制。

\subsection{多信使天文学观测}
将中微子探测与电磁波以及引力波等多种“信使”观测相结合，以识别中微子源、揭示其内部物理过程。
