...
制造的中微子进行探测。只有一部分具有探测宇宙中微子，即来自超新星，活跃星系核等中微子源的中微子的能力。
下面列举一些至少已经部分完成建造，且已有数据采集的具有宇宙中微子探测能力的探测器。
...
为内外两个区域，内部探测器包含 32,000 吨水，内壁安装了 11,146 个朝内的50厘米直径的大型光电倍增管，光电阴极覆盖率达
到40\%，用于精确测量粒子相互作用。外部探测器包围着内部探测器，包含18,000吨水，安装了1,885个朝外的20厘米
...
神冈探测器（Kamiokande）是 Super-K 的前身，其已于 1995 年退役。其首次直接观测到来自太阳系外的中微子，
...
域，质子等宇宙线被加速到极高能量，并通过与周围的物质或辐射场相互作用产生高能中微子。
